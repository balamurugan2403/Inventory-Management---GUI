...
public class CarDetail {
	...
	public int carID;					//Individual product details
	...
	public static Comparator<CarDetail> carIdComparator = new Comparator<CarDetail>() {//to sort based on Car ID
		public int compare(CarDetail c1, CarDetail c2) {//using compare method
	...
	public static Comparator<CarDetail> costComparator = new Comparator<CarDetail>() {//to sort based on Price
		public int compare(CarDetail c1, CarDetail c2) {
